...
export default function Home() {
  return (
    <main className="flex flex-col items-center">
      ...
      <div className="h-px w-3/5 min-w-6xl bg-gradient-to-r from-transparent via-[#C896FF]/15 to-transparent" />
      ...
      <section id="work" className="w-3/5 min-w-6xl py-[72px]">
        <div className="-mx-6 rounded-2xl bg-[rgba(15,7,30,0.5)] px-6 py-[72px]">
          ...
          <div className="grid grid-cols-2 overflow-hidden rounded-xl border border-[#C896FF]/12 bg-[rgba(10,5,21,0.6)]">
            <div className="flex aspect-[16/10] items-center justify-center border-r border-[#C896FF]/8 bg-gradient-to-br from-[#936EDC]/25 via-[#8C50FF]/15 to-[#3C1E96]/30 text-[0.75rem] tracking-[0.1em] text-[#C896FF]/30">
              [ JAIN 2.0 screenshot ]
            </div>
            <div className="p-8">
              <div className="mb-4 flex flex-wrap gap-2">
                {['UI Design', 'Design System', 'Motion'].map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-[#C896FF]/20 px-2.5 py-0.5 text-[0.65rem] tracking-[0.1em] text-[#C896FF]/60 uppercase"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <span className="group inline-flex cursor-not-allowed items-center gap-2 text-[0.82rem] text-[#C896FF]/40">
                View case study
                <span>→</span>
              </span>
            </div>
      ...
      <section id="currently" className="w-3/5 min-w-6xl py-20">
        ...
        <div className="flex items-center gap-10">
          <div className="w-[220px] shrink-0 overflow-hidden rounded-xl border border-[#C896FF]/15 bg-[rgba(15,7,30,0.8)]">
            <div className="flex items-center gap-2 border-b border-[#C896FF]/10 px-3.5 py-3 text-[0.65rem] tracking-[0.1em] text-[#C896FF]/50 uppercase">
              <span className="size-1.5 animate-pulse rounded-full bg-[#C896FF] shadow-[0_0_6px_rgba(200,150,255,0.8)]" />
              Now playing
            </div>
            <div className="flex items-center gap-3 px-3.5 py-3.5">
              <div className="flex size-[38px] shrink-0 items-center justify-center rounded-[6px] bg-gradient-to-br from-[#8C50FF]/50 to-[#3C1E96]/60 text-sm">
                ♪
              </div>
          ...
          <div>
            <h3 className="mb-2.5 text-[1.5rem] font-bold tracking-[-0.01em] text-white">What I&apos;m listening to</h3>
            ...
            <span className="mt-3.5 inline-block rounded-full border border-dashed border-[#C896FF]/25 px-3 py-1 text-[0.68rem] tracking-[0.1em] text-[#C896FF]/50 uppercase">
      ...
      <section id="contact" className="flex w-3/5 min-w-6xl flex-col items-center py-[72px] text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 rounded-full border border-[#C896FF]/35 bg-gradient-to-br from-[#8C50FF]/25 to-[#6432DC]/20 px-7 py-3 text-[0.9rem] text-[#C896FF]/90 transition-all hover:-translate-y-px hover:border-[#C896FF]/60 hover:text-[#C896FF]"
        >
          Say hello →
        </a>
